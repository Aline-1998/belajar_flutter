...
//
//     final harryPotterModels = harryPotterModelsFromJson(jsonString);

import 'dart:convert';

import 'package:json_annotation/json_annotation.dart';

part 'harry_potter_models.g.dart';

List<HarryPotterModels> harryPotterModelsFromJson(String str) =>
    List<HarryPotterModels>.from(
      json.decode(str).map((x) => HarryPotterModels.fromJson(x)),
    );

String harryPotterModelsToJson(List<HarryPotterModels> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

@JsonSerializable()
class HarryPotterModels {
  @JsonKey(name: "id")
  String id;
  @JsonKey(name: "name")
  String name;
  ...
  factory HarryPotterModels.fromJson(Map<String, dynamic> json) =>
      _$HarryPotterModelsFromJson(json);

  Map<String, dynamic> toJson() => _$HarryPotterModelsToJson(this);
}
